...
def createIP(dSize,kSize):
	...
	if IPparams :
		...
		tools.myWrite(substitute.compileVHD(dSize,kSize), os.environ['SIMON_WORKSPACE']+"/Simon_IPs/"+IPsimon+"/vhd/compile_vhd.sh")
		tools.myWrite(substitute.compileBench(dSize,kSize), os.environ['SIMON_WORKSPACE']+"/Simon_IPs/"+IPsimon+"/bench/compile_bench.sh")
		tools.myWrite(substitute.compileSynth(dSize,kSize), os.environ['SIMON_WORKSPACE']+"/Simon_IPs/"+IPsimon+"/synth/compile_synth.sh")
		tools.myWrite(substitute.simuBenchScript(), os.environ['SIMON_WORKSPACE']+"/Simon_IPs/"+IPsimon+"/bench/test.tcl")
		tools.myWrite(substitute.launchSimuBenchScript(), os.environ['SIMON_WORKSPACE']+"/Simon_IPs/"+IPsimon+"/bench/valid_IP.sh")
		os.chmod(os.environ['SIMON_WORKSPACE']+"/Simon_IPs/"+IPsimon+"/bench/valid_IP.sh",0775)
		tools.myWrite(substitute.simuSynthScript(), os.environ['SIMON_WORKSPACE']+"/Simon_IPs/"+IPsimon+"/synth/test.tcl")
		tools.myWrite(substitute.launchSimuSynthScript(), os.environ['SIMON_WORKSPACE']+"/Simon_IPs/"+IPsimon+"/synth/valid_IP.sh")
		tools.myWrite(substitute.launchSynthScript(dSize,kSize), os.environ['SIMON_WORKSPACE']+"/Simon_IPs/"+IPsimon+"/synth/autoSynth.tcl")
		os.chmod(os.environ['SIMON_WORKSPACE']+"/Simon_IPs/"+IPsimon+"/synth/valid_IP.sh",0775)
