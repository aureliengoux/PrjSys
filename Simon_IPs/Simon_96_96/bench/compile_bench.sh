...
vmap lib_bench_simon $HOME/Prj_Sys/Simon_IPs/Simon_96_96/bench/lib_bench_simon

vcom +acc -work lib_bench_simon  $HOME/Prj_Sys/Simon_IPs/Simon_96_96/bench/bench_top.vhd
